<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaticFloatingMenu.aspx.cs" Inherits="MenuExemples.Pages.StaticMenu" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Static Floating Menu</title>
    <!-- Include jQuery -->
    <script type="text/javascript" src='https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js'></script>
    <script type="text/javascript" src="../Scripts/WebForms/StaticFloatingMenu.js"></script>
    <link rel="stylesheet" href="../Resources/CSS/StaticFloatingMenu.css" />
</head>
<body>
    <form id="form1" runat="server">
        <div id="wrap">
            ...
            <div id="header">
                <div id="logo">
                    Start Slowly Scrolling Down<br />
                    This Page!
                </div>
                <div id="navWrap">
                    <div id="nav">
